  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-stadium text-7xl text-primary">404</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Liga Regional — Plataforma oficial da competição" },
      {
        name: "description",
        content:
          "Classificação, jogos, artilharia, clubes e rankings da Liga Regional em pontos corridos.",
      },
